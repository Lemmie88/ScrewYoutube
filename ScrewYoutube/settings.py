...
# TODO: Explain the reason behind public and private buckets.
PUBLIC_BUCKET_NAME = config('GS_BUCKET_NAME')
PRIVATE_BUCKET_NAME = config('GS_BUCKET_NAME')
THUMBNAIL_STORAGE_CLASS = STANDARD_STORAGE_CLASS
VIDEO_STORAGE_CLASS = STANDARD_STORAGE_CLASS
